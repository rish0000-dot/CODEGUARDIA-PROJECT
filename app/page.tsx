...
export default function Home() {
  ...
  return (
    <div style={{
      ...
      {/* 👤 PROFILE DROPDOWN - World Class UI */}
      {user && (
        <div style={{
          position: 'fixed',
          top: '2rem',
          ...
          >
            ...
            <div style={{ textAlign: 'left' }}>
              ...
              <div style={{ fontSize: '0.7rem', color: 'rgba(255,255,255,0.5)', marginTop: '2px' }}>{user.role}</div>
            </div>
          ...
          {showProfileMenu && (
            <div style={{
              ...
              <div style={{ padding: '0.5rem 1rem 1rem', borderBottom: '1px solid rgba(255,255,255,0.06)', marginBottom: '0.5rem' }}>
                <div style={{ fontSize: '0.75rem', color: 'rgba(255,255,255,0.4)', textTransform: 'uppercase', letterSpacing: '0.05em', fontWeight: '700' }}>Signed in as</div>
                <div style={{ fontSize: '0.9rem', color: 'white', fontWeight: '500', marginTop: '4px', overflow: 'hidden', textOverflow: 'ellipsis' }}>{user.email}</div>
              </div>
